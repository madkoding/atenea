"""`atenea-research list --status complete` was returning nothing.
...
Part of #2122 (atenea-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "atenea-research"
    loader = importlib.machinery.SourceFileLoader("atenea_research_cli", str(path))
