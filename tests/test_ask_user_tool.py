...
from src.agent.tools_facade import ToolBlock, TOOL_TAGS  # noqa: E402  (import first to avoid circular)
from src.tools.execution import execute_tool_block
from src.tools.index import ALWAYS_AVAILABLE, BUILTIN_TOOL_DESCRIPTIONS
from src.tools.security import is_public_blocked_tool
...
def test_registered_everywhere():
    ...
    from src.tools.schemas import FUNCTION_TOOL_SCHEMAS
