...
"""
from src.tools.execution import _promote_image_fields
...
def test_absolute_url_promoted_with_fields():
    ...
    r = _result(
        ...
        "Direct link: https://atenea.example.com/api/generated-image/abc123.png\n"
        "model: qwen-image\n"
        "size: 1024x1024"
    )
    _promote_image_fields(r)
    assert r["image_url"] == "https://atenea.example.com/api/generated-image/abc123.png"
