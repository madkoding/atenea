from src.actions.intents import classify_tool_intent, message_needs_tools
...
def test_explanatory_calendar_questions_stay_plain_chat():
    ...
    assert not message_needs_tools("What about the built-in Atenea calendar, is that linked to email?")
