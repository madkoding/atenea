#!/usr/bin/env python3
"""Create/remove the switchable, non-default 'Demo' EmailAccount in Atenea.

Mirrors the existing local-Dovecot account (localhost:31143, STARTTLS) but points
at the throwaway demo@atenea.local mailbox. Password is stored Fernet-encrypted
...
from src.security.secret_storage import encrypt  # noqa: E402

NAME = "Demo"
IMAP_USER = "demo@atenea.local"
