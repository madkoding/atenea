"""scripts/_lib/cli.py — shared scaffolding for the `atenea-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("atenea-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/atenea-foo`
...
VERSION = "0.1.0"  # bumped centrally; every atenea-* CLI reports this
