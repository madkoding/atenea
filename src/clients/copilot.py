...
COPILOT_USER_AGENT = os.environ.get(
    "ATENEA_COPILOT_USER_AGENT", "Atenea/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "ATENEA_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "ATENEA_COPILOT_EDITOR_VERSION", "Atenea/1.0"
)
