...
COLLECTION_NAME = "atenea_tool_index"
...
class ToolIndex:
    ...
    _KEYWORD_HINTS = {
        ...
        frozenset({"generate image", "create an image", "make an image",
                   "draw", "paint", "stable diffusion", "a1111",
                   "text to image", "text to img", "txt2img",
