...
from src.tools.security import is_public_blocked_tool, owner_is_admin_or_single_user
...
async def execute_tool_block(
    ...
    from src.tools.implementations import (
        ...
        do_edit_image, do_generate_images, do_trigger_research, do_manage_research, do_resolve_contact,
        do_manage_contact,
    ...
    if tool == "bash" and session_id:
        ...
        if _is_bg and _bg_cmd:
            import src.scheduling.bg_jobs as bg_jobs
    ...
    if tool in _MCP_TOOL_MAP:
        ...
        from src.agent.ai_interaction import dispatch_ai_tool
        ...
        desc = "images"
        result = await do_generate_images(content, owner=owner)
