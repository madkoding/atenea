...
from src.chat.helpers import extract_urls, model_supports_vision
from src.documents.processor import build_user_content, analyze_image_with_vl_result
from src.youtube.handler import (
    is_youtube_url,
    extract_youtube_id,
