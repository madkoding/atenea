...
- [ ] I searched [open issues](https://github.com/pewdiepie-archdaemon/atenea/issues) and [open PRs](https://github.com/pewdiepie-archdaemon/atenea/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Atenea's existing visual language. Specifically:
