...
function initMermaid() {
  if (!window.mermaid || window.__ateneaMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__ateneaMermaidReady = true;
}
window.ateneaInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'atenea-thinking-expanded';
