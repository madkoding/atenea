...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'atenea-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'atenea-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('atenea:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
